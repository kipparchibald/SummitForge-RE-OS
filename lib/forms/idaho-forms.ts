  ...
  generateRE21(): PopulatedForm {
    return {
      ...
      populatedFields: {
        ...
        earnestHeldBy: this.transactionData.earnestHeldBy || this.transactionData.titleCompany || '',
        closingDate: this.transactionData.closingDate || '',
        financingType: this.transactionData.financingType || 'Conventional',
        financingDetails: this.transactionData.financingDetails || '',
        loanAmount: this.transactionData.loanAmount || '',
        inspectionPeriod: this.transactionData.inspectionDays || '10',
        inspectionDeadline: this.transactionData.inspectionDeadline || '',
        contingencies: this.transactionData.contingencies || '',
        additionalTerms: this.transactionData.additionalTerms || '',
        titleCompany: this.transactionData.titleCompany || '',
        titleOfficer: this.transactionData.titleOfficer || '',
        agentName: this.agentData.name || '',
        brokerage: this.agentData.brokerage || '',
      },
      pdfReady: true,
      exportFormat: 'pdf',
      notes: 'Core residential PSA — populated from cover letter'
    };
  }
  ...
  generateRE24(): PopulatedForm {
    return {
      ...
      populatedFields: {
        ...
        parcelOrApn: this.propertyData.parcelOrApn || '',
        purchasePrice: this.transactionData.purchasePrice || '',
        buyerName: this.buyerData.name || '',
        sellerName: this.sellerData.name || '',
        earnestMoney: this.transactionData.earnestMoney || '',
      ...
      pdfReady: true,
      exportFormat: 'pdf',
      notes: 'Vacant land PSA — cover letter + legal description'
    };
  }
